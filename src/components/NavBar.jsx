...
// from the icon font: two glyphs don't justify a webfont request, and an
...
const BACK = 'M655-80 255-480l400-400 56 57-343 343 343 343-56 57Z'

// Three columns rather than space-between, so the title sits in the
// actual middle instead of the middle of what's left over.
export default function NavBar({ settingsOpen, onToggleSettings }) {
  return (
    <header className="nav">
      <button type="button" className="nav-button" onClick={onToggleSettings}>
        <Icon
          path={settingsOpen ? BACK : SETTINGS}
